<!DOCTYPE html>
<html>
    <head><title>Visitors Management System</title>
<link rel="stylesheet" type="text/css" href="css/style.css">
</head>
    <body>
        <div class="header">
        <h1><img src="images/logo.png" width="170" height="155" align="middle" style="border-radius:90px">Visitors Management System</h1>
        <div class="nav">
            <ul>
